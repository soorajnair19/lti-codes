...
public class Servlet2 extends HttpServlet {
	...
	session.save(r4);
	tx.commit();
	SQLQuery query = session.createSQLQuery("select"+"readerid,email,firstName,title from Reader r,Subscription s"+
	"where r.readerid=s.readerid");
	List rlist = query.list();
	
	request.setAttribute("readersub", rlist);
